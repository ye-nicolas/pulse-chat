...
public class FriendShipRepositoryImpl implements FriendShipRepository {
    ...
    public FriendShipData mapToData(Map<String, Object> map) {
        return FriendShipData.builder()
                ...
                .createdAt(TypeUtil.toInstant((OffsetDateTime) map.get(DbMeta.FriendShipData.ALIAS_CREATED_AT)))
                .updatedAt(TypeUtil.toInstant((OffsetDateTime) map.get(DbMeta.FriendShipData.ALIAS_UPDATED_AT)))
